...
func (mw *MagickWand) BorderImage(borderColor *PixelWand, width, height uint) error {
	C.MagickBorderImage(mw.mw, borderColor.pw, C.ulong(width), C.ulong(height))
	return mw.GetLastError()
}
*/
...
func (mw *MagickWand) ChopImage(width, height uint, x, y int) error {
	C.MagickChopImage(mw.mw, C.ulong(width), C.ulong(height), C.long(x), C.long(y))
	return mw.GetLastError()
}
...
func (mw *MagickWand) ClipImagePath(pathname string, inside bool) error {
	...
	C.MagickClipPathImage(mw.mw, cspathname, b2i(inside))
	return mw.GetLastError()
}

// Replaces colors in the image from a color lookup table
func (mw *MagickWand) ClutImage(clut *MagickWand) error {
	C.MagickHaldClutImage(mw.mw, clut.mw)
	return mw.GetLastError()
}
...
func (mw *MagickWand) ConvolveImage(order uint, kernel []float64) error {
	C.MagickConvolveImage(mw.mw, C.ulong(order), (*C.double)(&kernel[0]))
	return mw.GetLastError()
}
...
func (mw *MagickWand) CycleColormapImage(displace int) error {
	C.MagickCycleColormapImage(mw.mw, C.long(displace))
	return mw.GetLastError()
}
...
func (mw *MagickWand) FrameImage(matteColor *PixelWand, width, height uint, innerBevel, outerBevel int) error {
	C.MagickFrameImage(mw.mw, matteColor.pw, C.ulong(width), C.ulong(height), C.ssize_t(innerBevel), C.ssize_t(outerBevel))
	return mw.GetLastError()
}
*/
...
func (mw *MagickWand) GetImageBlob() []byte {
	clen := C.size_t(0)
	csblob := C.MagickWriteImageBlob(mw.mw, &clen)
...
func (mw *MagickWand) GetImageColormapColor(index uint) (color *PixelWand, err error) {
	cpw := NewPixelWand()
	C.MagickGetImageColormapColor(mw.mw, C.ulong(index), cpw.pw)
...
func (mw *MagickWand) MorphImages(numFrames uint) *MagickWand {
	//
	return &MagickWand{C.MagickMorphImages(mw.mw, C.ulong(numFrames))}
}
...
func (mw *MagickWand) QuantizeImage(numColors uint, colorspace ColorspaceType, treedepth uint, dither bool, measureError bool) error {
	C.MagickQuantizeImage(mw.mw, C.ulong(numColors), C.ColorspaceType(colorspace), C.ulong(treedepth), b2i(dither), b2i(measureError))
	return mw.GetLastError()
}
...
func (mw *MagickWand) QuantizeImages(numColors uint, colorspace ColorspaceType, treedepth uint, dither bool, measureError bool) error {
	C.MagickQuantizeImages(mw.mw, C.ulong(numColors), C.ColorspaceType(colorspace), C.ulong(treedepth), b2i(dither), b2i(measureError))
	return mw.GetLastError()
}
...
func (mw *MagickWand) RaiseImage(width uint, height uint, x int, y int, raise bool) error {
	C.MagickRaiseImage(mw.mw, C.ulong(width), C.ulong(height), C.long(x), C.long(y), b2i(raise))
	return mw.GetLastError()
}
...
func (mw *MagickWand) ReadImageBlob(blob []byte) error {
	...
	C.MagickReadImageBlob(mw.mw, (*C.uchar)(unsafe.Pointer(&blob[0])), C.size_t(len(blob)))
	return mw.GetLastError()
}
...
//
func (mw *MagickWand) RemapImage(remap *MagickWand, method uint) error {
	C.MagickMapImage(mw.mw, remap.mw, C.uint(method))
	return mw.GetLastError()
}
...
func (mw *MagickWand) RollImage(x, y int) error {
	C.MagickRollImage(mw.mw, C.long(x), C.long(y))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SampleImage(cols, rows uint) error {
	C.MagickSampleImage(mw.mw, C.ulong(cols), C.ulong(rows))
	return mw.GetLastError()
}

// Scales the size of an image to the given dimensions.
func (mw *MagickWand) ScaleImage(cols, rows uint) error {
	C.MagickScaleImage(mw.mw, C.ulong(cols), C.ulong(rows))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SetImageChannelDepth(channel ChannelType, depth uint) error {
	C.MagickSetImageChannelDepth(mw.mw, C.ChannelType(channel), C.ulong(depth))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SetImageColormapColor(index uint, color *PixelWand) error {
	C.MagickSetImageColormapColor(mw.mw, C.ulong(index), color.pw)
	return mw.GetLastError()
}
*/
...
func (mw *MagickWand) SetImageCompressionQuality(quality uint) error {
	C.MagickSetCompressionQuality(mw.mw, C.ulong(quality))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SetImageDelay(delay uint) error {
	C.MagickSetImageDelay(mw.mw, C.ulong(delay))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SetImageIterations(iterations uint) error {
	C.MagickSetImageIterations(mw.mw, C.ulong(iterations))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SetImagePage(width, height uint, x, y int) error {
	C.MagickSetImagePage(mw.mw, C.ulong(width), C.ulong(height), C.long(x), C.long(y))
	return mw.GetLastError()
}
...
func (mw *MagickWand) SetImageScene(scene uint) error {
	C.MagickSetImageScene(mw.mw, C.ulong(scene))
	return mw.GetLastError()
}
...
func (mw *MagickWand) ShaveImage(cols, rows uint) error {
	C.MagickShaveImage(mw.mw, C.ulong(cols), C.ulong(rows))
	return mw.GetLastError()
}
...
//	C.MagickStatisticImage(mw.mw, C.StatisticType(stype), C.ulong(width), C.ulong(height))
//	return mw.GetLastError()
//}
...
//	C.MagickStatisticImageChannel(mw.mw, C.ChannelType(channel), C.StatisticType(stype), C.ulong(width), C.ulong(height))
//	return mw.GetLastError()
//}
...
func (mw *MagickWand) SteganoImage(watermark *MagickWand, offset int) *MagickWand {
	return &MagickWand{C.MagickSteganoImage(mw.mw, watermark.mw, C.long(offset))}
}
...
func (mw *MagickWand) WriteImagesFile(out *os.File) error {
	...
	defer C.fclose(file)
	C.MagickWriteImagesFile(mw.mw, file, C.uint(1))
	return mw.GetLastError()
}
